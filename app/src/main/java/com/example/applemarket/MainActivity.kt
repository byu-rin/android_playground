...
//        dataList.add(SaleItem(R.drawable.sample1, "산지 한달된 샨풍기 팝니다.", "이사가서 필요가 없어졌어요 급하게 내놓습니다","대현동",1000,"서울 서대문구 창천동",13,25))
//        dataList.add(SaleItem(R.drawable.sample2, "김치냉장고", "이사로인해 내놔요","안마담",20000,"인천 계양구 귤현동",8,28))
